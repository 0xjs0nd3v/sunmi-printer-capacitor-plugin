...
import type { SunmiPrinterPluginPlugin ,PrinterModeEnum, PrinterStatusEnum, ServiceStatusEnum } from './definitions';

export class SunmiPrinterPluginWeb extends WebPlugin implements SunmiPrinterPluginPlugin {
