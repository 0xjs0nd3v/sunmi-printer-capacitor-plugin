...
import com.veridata.plugins.internals.AsciiBitmapConverter;
import com.veridata.plugins.internals.BarcodeUtil;

@CapacitorPlugin(name = "SunmiPrinterPlugin")
public class SunmiPrinterPluginPlugin extends Plugin {

    private SunmiPrinterPlugin implementation = new SunmiPrinterPlugin();
